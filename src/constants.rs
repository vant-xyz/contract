...
pub const ER_VALIDATOR: Pubkey =
    solana_program::pubkey!("MEUGGrYPxKk17hCr7wpT6s8dtNokZj5U2L57vjYMS8e");
pub const MARKET_SEED: &[u8] = b"market";
pub const VS_EVENT_SEED: &[u8] = b"vs_event";
...
pub const VS_EVENT_ACCOUNT_SIZE: usize = 3000;
...
pub const MAX_VS_PARTICIPANTS: usize = 32;
